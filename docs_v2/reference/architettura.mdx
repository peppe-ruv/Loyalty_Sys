---
title: "Architettura: microservizi Spring Boot coreografati su Kafka"
...
Approfondisci i singoli servizi in [Servizi](/docs_v2/reference/servizi) o i contratti eventi in [Eventi Kafka](/docs_v2/reference/eventi-kafka).
