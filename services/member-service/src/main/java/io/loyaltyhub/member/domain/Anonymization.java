...
public final class Anonymization {
    ...
    // SPEC-GAP: Q-B1 — docs/03 dice "nome → 'Membro anonimo'" senza dire in quale campo: il segnaposto va nel
    ...
    // SPEC-GAP: Q-B2 — attributi personalizzati: le definizioni non dicono quali sono personali (es. `city`,
