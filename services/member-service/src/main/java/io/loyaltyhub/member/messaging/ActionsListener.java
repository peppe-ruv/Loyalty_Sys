...
/**
 * Consuma {@code lh.actions.v1} e instrada all'{@link EventRouter} (docs/06 §5): tutte le azioni
 * aggiornano {@code member_stats}. Nessuna logica qui; ack manuale dopo il commit.
 */
@Component
public class ActionsListener {
    ...
    public ActionsListener(@Qualifier("memberEventRouter") EventRouter router, ObjectMapper mapper) {
        this.router = router;
        this.mapper = mapper;
    }
