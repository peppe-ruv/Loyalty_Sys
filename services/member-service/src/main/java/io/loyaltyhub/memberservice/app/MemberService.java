...
import io.loyaltyhub.memberservice.domain.Anonymizer;
import io.loyaltyhub.memberservice.domain.Member;
...
public class MemberService {
    ...
    public MemberService(JdbcTemplate jdbc, KafkaTemplate<String, byte[]> kafka, ReferralPolicy referral, io.loyaltyhub.common.metrics.LoyaltyMetrics metrics) {
    ...
    private void publishMember(Member m) {
        var e = CanonicalEvents.of(EventTypes.MEMBER_V1, "urn:loyaltyhub:members", "member:" + m.id(), m);
    ...
    private void publishAction(String memberId, RewardingAction a) {
        var e = CanonicalEvents.of(EventTypes.ACTION_V1, "urn:loyaltyhub:members", "member:" + memberId, a);
