...
import io.loyaltyhub.memberservice.app.MemberService;
...
public class MemberController {
    ...
    public Map<String, Object> referral(@PathVariable String id) {
        ...
        return Map.of("code", m.referralCode() == null ? "" : m.referralCode(), "shareUrl", System.getenv().getOrDefault("SITE_URL", "https://loyalty.example.com") + "/aderisci?ref=" + m.referralCode());
    }
