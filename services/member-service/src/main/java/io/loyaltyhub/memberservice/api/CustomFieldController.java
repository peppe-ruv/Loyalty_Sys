...
import io.loyaltyhub.memberservice.domain.CustomFieldSchema;
import io.loyaltyhub.memberservice.domain.CustomFieldSource;
import io.loyaltyhub.memberservice.domain.MemberIdentifiers;
    ...
    public Map<String, Object> get(@PathVariable String id) {
        ...
        for (var r : rows) {
            try {
                ...
                // Nessun id membro nel log (ADR-012): basta il gruppo per trovare la riga.
