...
/**
 * Membro del programma (RF-72): identità = sub OIDC (ADR-012), nessun dato anagrafico duplicato dal CRM.
 * Etichette chiave/valore libere per segmenti e regole; consensi per chiave.
