package io.loyaltyhub.rulesengine.messaging;
...
import io.loyaltyhub.rulesengine.client.*;
...
/**
 * Consuma le azioni premianti (esterne e interne, stesso topic: ADR-008), valuta le campagne (RF-80) e applica gli effetti:
...
public class ActionConsumer {
    ...
    public ActionConsumer(CampaignSource campaigns, CampaignEvaluator evaluator, LedgerClient ledger, TierClient tiers, SegmentClient segments, RewardClient rewards, EngagementClient engagement,
                          io.loyaltyhub.common.metrics.LoyaltyMetrics metrics, @org.springframework.beans.factory.annotation.Value("${rules.apply-effects:true}") boolean applyEffects) {
