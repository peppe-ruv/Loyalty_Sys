package it.iren.loyalty.decisionservice;
...
import it.iren.loyalty.decisionservice.app.*;
...
public class DecisionConfig {
    ...
    /** Esecuzione degli effetti sui servizi di dominio; le azioni interne vanno sul topic canonico (stessa forma delle esterne, D08). */
    @Bean @ConditionalOnMissingBean
    Effects effects(RestClient.Builder builder, KafkaTemplate<String, byte[]> kafka) {
        ...
        String source = "urn:iren:loyalty:decision-service";
        return new Effects() {
