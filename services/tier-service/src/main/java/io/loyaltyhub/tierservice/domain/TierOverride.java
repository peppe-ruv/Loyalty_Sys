...
/**
 * Assegnazione manuale del tier (RF-70): il customer care o
 * il marketing fissano un tier con causale e scadenza (es. "TOP per 12 mesi come gesto commerciale", "tier ereditato
 * dal programma precedente"). Finché è valida prevale sul calcolo; alla scadenza si torna al tier qualificato, senza scendere più di un
