package io.loyaltyhub.tierservice.app;
...
public class TierUpdater {
    ...
    public TierUpdater(JdbcTemplate jdbc, KafkaTemplate<String, byte[]> kafka, io.loyaltyhub.common.metrics.LoyaltyMetrics metrics) { this.jdbc = jdbc; this.kafka = kafka; this.metrics = metrics; }
    ...
    private void changed(String memberId, String from, String to, String reason) {
        ...
        var e = CanonicalEvents.of(EventTypes.TIER_CHANGED_V1, "urn:loyaltyhub:tiers", "member:" + memberId, Map.of("fromTier", from, "toTier", to, "reason", reason, "at", now.toString()));
        ...
        kafka.send(EventTypes.TOPIC_ACTIONS, memberId, CanonicalEvents.serialize(CanonicalEvents.of(EventTypes.ACTION_V1, "urn:loyaltyhub:tiers", "member:" + memberId, a)));
