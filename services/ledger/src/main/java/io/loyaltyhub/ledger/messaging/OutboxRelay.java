package io.loyaltyhub.ledger.messaging;

import io.loyaltyhub.ledger.domain.Outbox;
...
public class OutboxRelay {
    ...
    public OutboxRelay(Repositories.OutboxRepository outbox, KafkaTemplate<String, byte[]> kafka, io.loyaltyhub.common.metrics.LoyaltyMetrics metrics) {
        this.outbox = outbox;
        this.kafka = kafka;
