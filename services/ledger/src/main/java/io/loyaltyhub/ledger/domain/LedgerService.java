...
public class LedgerService {
    ...
    public LedgerService(Repositories.MovementRepository movements, Repositories.BalanceRepository balances, Repositories.OutboxRepository outbox, WalletTypeSource wallets, io.loyaltyhub.common.metrics.LoyaltyMetrics metrics) {
    ...
    private void emit(Movement m, Balance b) {
        ...
        var event = CanonicalEvents.of(EventTypes.MOVEMENT_V1, "urn:loyaltyhub:ledger", "member:" + m.getMemberId(), Map.of(
