...
import io.loyaltyhub.ledger.domain.WalletType;
import io.loyaltyhub.ledger.domain.WalletTypeSource;
...
@EnableJpaRepositories(basePackages = "io.loyaltyhub.ledger.domain", considerNestedRepositories = true)
public class LedgerConfig {
    /** Wallet di default (ADR-005); in produzione l'adattatore CMS aggiunge quelli configurati (RF-87). */
    @Bean
