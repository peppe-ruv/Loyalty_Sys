...
/**
 * Tipo di wallet configurabile dal backoffice (RF-87), equivalente dei "wallet types" di Open Loyalty: codice, nomi
 * dell'unità (singolare/plurale), scadenza, sospensione, limiti, saldo negativo, stato. PREMIO e STATUS sono i wallet
 * di default (D05) e non si disattivano; un wallet in più (es. BOLLINI di una raccolta) si aggiunge senza codice.
 */
