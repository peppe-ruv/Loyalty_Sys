package io.loyaltyhub.catalogredemption.api;

import io.loyaltyhub.catalogredemption.domain.CouponPool;
import io.loyaltyhub.catalogredemption.domain.RedemptionService;
import io.loyaltyhub.catalogredemption.domain.RedemptionState;
...
public class RedemptionController {
    ...
    public Map<String, Object> payWithPoints(@RequestBody PayWithPoints p) {
        var conv = new io.loyaltyhub.catalogredemption.domain.UnitsConversion(new java.math.BigDecimal(System.getenv().getOrDefault("EUR_PER_UNIT", "0.01")), 100, 0, 100);
