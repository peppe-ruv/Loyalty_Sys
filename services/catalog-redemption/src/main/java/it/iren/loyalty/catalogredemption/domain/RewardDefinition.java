...
/**
 * Premio del catalogo (RF-14, RF-74..RF-76): tipi a parità con le "reward campaigns" di Open Loyalty tradotti su Iren.
 * VOUCHER buono digitale con codice; PHYSICAL premio fisico; SERVICE servizio (es. manutenzione caldaia);
 * CASHBACK accredito in bolletta via SAP (il "cashback" di OL); DISCOUNT_PERCENT / DISCOUNT_VALUE codice sconto
 * percentuale o a valore (su offerte e negozio); FREE_SERVICE servizio gratuito (equivalente della "free delivery");
