...
/** Consuma {@code lh.facts.v1} per gamification (docs/servizi/gamification-service.md §4); i tipi senza handler si ignorano. */
@Component
...
public class FactsListener {
    ...
    public FactsListener(@Qualifier("gamificationEventRouter") EventRouter router, ObjectMapper mapper) {
        this.router = router;
        this.mapper = mapper;
    }
