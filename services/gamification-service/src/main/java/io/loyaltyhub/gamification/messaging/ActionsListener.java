...
/** Consuma {@code lh.actions.v1} per gamification (docs/servizi/gamification-service.md §4); i tipi senza handler si ignorano. */
@Component
public class ActionsListener {
    ...
    public ActionsListener(@Qualifier("gamificationEventRouter") EventRouter router, ObjectMapper mapper) {
        this.router = router;
        this.mapper = mapper;
    }
