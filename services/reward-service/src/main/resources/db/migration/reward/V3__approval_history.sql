-- V3 — storico delle transizioni degli oggetti governati (docs/06 §1, §7; docs/03 §3.6; F-APR-01, M7.1).
...
-- Il rifiuto riporta in DRAFT (docs/03 §3.6): lo stato REJECTED usato fino a M6 non esiste più.
UPDATE reward SET status = 'DRAFT' WHERE status = 'REJECTED';
