 ...
 * 180 giorni, ogni notte. Attivo solo con {@code loyaltyhub.jobs.enabled=true} (spento in demo, come negli altri servizi).
 */
@Component
@Lazy(false)
...
public class EngagementJobs {
    ...
    public EngagementJobs(InboxRepository inbox, Clock clock) {
        this.inbox = inbox;
        this.clock = clock;
    }
