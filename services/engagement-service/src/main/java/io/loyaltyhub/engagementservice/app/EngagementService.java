...
/**
 * Consuma le azioni (ADR-008) e aggiorna achievement, challenge e punteggi delle classifiche del membro; ogni avanzamento o
...
public class EngagementService {
    ...
    public EngagementService(JdbcTemplate jdbc, KafkaTemplate<String, byte[]> kafka, Definitions defs, io.loyaltyhub.common.metrics.LoyaltyMetrics metrics) { this.jdbc = jdbc; this.kafka = kafka; this.defs = defs; this.metrics = metrics; }
    ...
    private void emit(String memberId, String type, String key, String ref, Instant at, Map<String, Object> attrs) {
        ...
        kafka.send(EventTypes.TOPIC_ACTIONS, memberId, CanonicalEvents.serialize(CanonicalEvents.of(EventTypes.ACTION_V1, "urn:loyaltyhub:engagement", "member:" + memberId, a)));
    }
