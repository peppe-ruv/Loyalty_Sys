package it.iren.loyalty.engagementservice.api;

import it.iren.loyalty.engagementservice.app.EngagementService;
...
public class EngagementController {
    ...
    /** Aggiornamento manuale del progresso (API "update progress" di Open Loyalty): passa da un'azione interna con causale, così resta tracciato. */
    ...
    public Map<String, String> manualProgress(@RequestBody ManualProgress p) {
        ...
        engagement.apply(p.memberId(), new it.iren.loyalty.common.event.RewardingAction(p.actionType(), "manual:" + p.memberId() + ":" + p.actionType() + ":" + System.currentTimeMillis(), null, java.time.Instant.now(), null, attrs));
