package io.loyaltyhub.ingressadapters.publish;
 ...
 * che riproverà: i consumer sono idempotenti (RI-01, ADR-008) e un duplicato non fa danno.
 */
@Component
public class ActionPublisher {
    ...
    public void reject(String source, String memberId, RewardingAction action, String reason) {
        var event = CanonicalEvents.of(EventTypes.ACTION_V1 + ".rejected", "urn:loyaltyhub:source:" + source,
