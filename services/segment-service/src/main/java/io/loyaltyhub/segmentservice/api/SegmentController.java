package io.loyaltyhub.segmentservice.api;

import io.loyaltyhub.segmentservice.app.SegmentRecompute;
...
public class SegmentController {
    ...
    /** Export per marketing/CRM (RF-71): solo id membro e data di ingresso, nessun dato anagrafico (ADR-012). */
