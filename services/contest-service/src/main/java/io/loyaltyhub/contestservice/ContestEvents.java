...
/**
 * Eventi di esito dei concorsi (ADR-008, RF-38): CONTEST_RESULT per CRM/BI/notifiche e le azioni interne CONTEST_PLAYED /
...
public class ContestEvents {
    ...
    public void played(String contestId, String memberId, String playId, boolean won, String prizeCode, Instant at) {
        ...
        kafka.send(EventTypes.TOPIC_CONTESTS, memberId, CanonicalEvents.serialize(CanonicalEvents.of(EventTypes.CONTEST_RESULT_V1, "urn:loyaltyhub:contests", "member:" + memberId, data)));
    ...
    private void action(String memberId, String type, String key, String ref, Instant at, Map<String, Object> attrs) {
        ...
        kafka.send(EventTypes.TOPIC_ACTIONS, memberId, CanonicalEvents.serialize(CanonicalEvents.of(EventTypes.ACTION_V1, "urn:loyaltyhub:contests", "member:" + memberId, a)));
    }
}
