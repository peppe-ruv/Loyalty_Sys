...
public class WheelService {
    ...
    public WheelService(JdbcTemplate jdbc, WheelSource wheels, InstantWinService instantWin, RestClient.Builder b, io.loyaltyhub.common.metrics.LoyaltyMetrics metrics, io.loyaltyhub.contestservice.ContestEvents events) {
