package io.loyaltyhub.contestservice.api;

import io.loyaltyhub.contestservice.instantwin.InstantWinService;
...
/** Giocata sincrona (RF-51): esito nella stessa richiesta. L'azione premiante CONTEST_PLAYED/WON è emessa via outbox (ADR-008). */
@RestController
...
public class PlayController {
    ...
    private final io.loyaltyhub.contestservice.ContestEvents events;
    public PlayController(InstantWinService service, io.loyaltyhub.contestservice.ContestEvents events) { this.service = service; this.events = events; }
