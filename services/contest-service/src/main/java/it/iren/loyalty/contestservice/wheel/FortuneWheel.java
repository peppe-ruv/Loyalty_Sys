 ...
 * l'estrazione (livello di business logic, come in Open Loyalty). Ogni giro è indipendente dal precedente.
 *
...
public record FortuneWheel(String id, String name, boolean active, Mode mode, String contestId, List<Slot> slots, String costWallet, long costUnits,
                           int spinsPerMember, it.iren.loyalty.contestservice.wheel.Period spinsPeriod, Instant startsAt, Instant endsAt,
