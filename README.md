...
| `web/playground/` | Playground statico: i pattern e il motore decisionale su dati finti, senza backend · static playground: patterns and decision engine on fake data, no backend |
