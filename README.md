...
| `web/backoffice-design-system/` | Design system del backoffice: contratti dei 15 pattern, **componenti React** che li implementano, token di tema sulle primitive [Design Tokens Italia](https://github.com/italia/design-tokens-italia) (ADR-026, ADR-027) · back-office design system: contracts for the 15 patterns, the **React components** implementing them, theme tokens built on Design Tokens Italia |
