...
| M5 — Gioco | in corso | 2026-09-24 | | ☐ | M5.1–M5.3 chiuse (concorsi, istanti con seme, BO-14; giocata, crediti, PT-05/PT-06; consegna vincite via ponte) |
| M6 — Contenuti | da iniziare | | | ☐ | |
| M7 — Governance | da iniziare | | | ☐ | |

**Prossima fetta da lavorare:** M5.4 (obiettivi, badge, effetto `AWARD_BADGE`, BO-15, PT-09); resta `smoke.sh` sulla demo online per M3–M4
