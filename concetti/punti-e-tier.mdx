...
Il consumo segue la regola **FIFO** (first in, first out): quando il membro spende punti, wallet preleva prima dai lotti `ACTIVE` più vecchi. Questo protegge i punti che stanno per scadere.
