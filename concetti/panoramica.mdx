...
<CardGroup cols={2}>
  <Card title="Azioni e campagne" icon="bolt" href="concetti/azioni-e-campagne">
  ...
  <Card title="Architettura" icon="layer-group" href="reference/architettura">
...
Approfondisci il funzionamento del motore in [Azioni e campagne](concetti/azioni-e-campagne).
